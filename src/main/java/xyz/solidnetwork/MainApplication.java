package xyz.solidnetwork;

import xyz.solidnetwork.animal.*;

import java.util.Scanner;
import java.util.Arrays;

import xyz.solidnetwork.toy.*;
import xyz.solidnetwork.statics.*;
import xyz.solidnetwork.polymorphism.*;
import xyz.solidnetwork.interfaces.*;
